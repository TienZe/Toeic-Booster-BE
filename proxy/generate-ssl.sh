...
# docker run --rm -it   -v "$(pwd)/proxy/ssl:/etc/letsencrypt/live" -v certbot/certbot certonly --webroot     -w /var/www/certbot     -d toeicbooster.io.vn     -d www.toeicbooster.io.vn     --email hertyv27@gmail.com     --agree-tos     --no-eff-email     -v
